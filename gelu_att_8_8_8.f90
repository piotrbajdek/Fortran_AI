...
program gelu_att_8_8_8
  ...
  do i=1, iterations
      ...
      do j=9, seq_len
          hidden_state(j) = gelu(dot_product(w1, sequence(j-8:j-1)) + b1) + &
                            gelu(dot_product(w2, sequence(j-8:j-1)) + b2) + &
                            gelu(dot_product(w3, sequence(j-8:j-1)) + b3)
  ...
  y_pred = gelu(dot_product(w1, sequence(seq_len-8:seq_len-1)) + b1) + &
           gelu(dot_product(w2, sequence(seq_len-8:seq_len-1)) + b2) + &
           gelu(dot_product(w3, sequence(seq_len-8:seq_len-1)) + b3)
